...
public class ClubController {
	...
	@GetMapping("/{clubId}")
	public ResponseEntity<ApiResponse<ClubInfoResponse>> getClubById(
		@AuthenticationPrincipal SecurityMemberDetails memberDetails, @PathVariable Long clubId) {
	...
	public ResponseEntity<ApiResponse<URL>> updateClubPhoto(
		@PathVariable Long clubId,
		@RequestBody
	...
	public ResponseEntity<ApiResponse<URL>> getClubPhoto(@PathVariable Long clubId) {
		return ResponseEntity.ok(
			ApiResponse.success(
				clubService.getClubPhoto(clubId)
			)
		);
	}
